...
@Controller
@RequestMapping("/doctor-clock-in")
public class DoctorClockInController {

	private final UserService userService;

	public DoctorClockInController(UserService userService) {
	...
	public String index(Model uiModel, @AuthenticationPrincipal UserDetails userDetails) {
		...
		uiModel.addAttribute("pageTitle", "Doctor Clock-In");

		return "doctor-clock-in/doctor-clock-in";
	}
